...
exports.get = exports.c = exports.t = exports.sect_id = void 0;
...
class str_atom {
    ...
    len;
    constructor(len, v) {
        (0, assert_1.default)(len.v == v.length);
        this.t = T.str;
...
function varuint32(value) {
    ...
    (0, assert_1.default)(value >= 0 && value <= 0xffffffff);
    let v = value;
    const bytes = [];
    while (v >= 0x80) {
...
function varint7(value) {
    (0, assert_1.default)(value >= -64 && value <= 63);
...
function varint32(value) {
    (0, assert_1.default)(value >= -0x80000000 && value <= 0x7fffffff);
...
function varint64(value) {
    ...
    (0, assert_1.default)(value >= Number.MIN_SAFE_INTEGER && value <= Number.MAX_SAFE_INTEGER);
...
function if_(r, cond, then_, else_) {
    (0, assert_1.default)(r === then_[then_.length - 1].r);
    (0, assert_1.default)(!else_ || else_.length == 0 || r === else_[else_.length - 1].r);
...
exports.c = {
    ...
    func_type_m(paramTypes, returnTypes) {
        const paramLen = varuint32(paramTypes.length);
        const resultLen = varuint32(returnTypes.length);
        return new cell(T.func_type, [Func, paramLen, ...paramTypes, resultLen, ...returnTypes]);
    },
    table_type(type, limits) {
        (0, assert_1.default)(type.v == AnyFunc.v); // WASM MVP limitation
    ...
    block(r, body) {
        (0, assert_1.default)(r === body[body.length - 1].r);
        return new instr_imm1_post(0x02, r, r, [...body, end]);
    },
    void_block(body) {
        (0, assert_1.default)(body.length == 0 || Void === body[body.length - 1].r);
    ...
    select(cond, trueRes, falseRes) {
        (0, assert_1.default)(trueRes.r === falseRes.r);
...
//# sourceMappingURL=wasm-emitter.js.map